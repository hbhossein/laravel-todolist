    ...
    <div class="container m-5 p-2 rounded mx-auto bg-light shadow">
        ...
        <div class="row mx-1 px-5 pb-3 w-80">
            <div class="col mx-auto">
                ...
                <div class="row px-3 align-items-center todo-item rounded">
                    <div class="col px-1 m-1 d-flex align-items-center">
                        <a href="{{ route('usersTask', $user) }}" class="form-control form-control-lg border-0 edit-todo-input bg-transparent rounded px-3">{{ $user->name }}</a>
                    </div>
                    <div class="col-auto m-1 p-0 px-2">
                        <div class="row">
                            <div class="col-auto d-flex align-items-center rounded bg-white border border-warning">
                                <i class="fa fa-hourglass-2 my-2 px-2 text-warning btn" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Due on date"></i>
                                <h6 class="text my-2 pr-2">{{ $user->email }}</h6>
                            </div>
                        </div>
                    </div>
                    @role('manager')
